...
class YOLO:
    ...
    def screen_predict(self, label_id, score=0.8):  # DetectionResult: [xmin, ymin, xmax, ymax, score, label_id]
        """
        yolo对屏幕截屏推测
    ...
    def screen_predict_raw(self, label_id, score=0.8):  # DetectionResult: [xmin, ymin, xmax, ymax, score, label_id]
        """
...
yo_1 = YOLO(path=static_path + "model/your_model_1.onnx")
yo_2 = YOLO(path=static_path + "model/your_model_2.onnx")
